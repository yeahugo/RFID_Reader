...
public class BluetoothCommService {
    ...
    private static ArrayList<IReadCard> cardReceivers=new ArrayList<IReadCard>();
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(ShowCard.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(ShowCard.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(ShowCard.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(ShowCard.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ShowCard.TOAST, "此蓝牙不可以连接！");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(ShowCard.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ShowCard.TOAST, "蓝牙连接断开！");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(ShowCard.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
    ...
    public static void AddCardReceiver(IReadCard iReceiver)
	{
	 ...
	 * 删除读卡观察者
	 */
	public static void RemoveCardReceiver(IReadCard iReceiver)
	{
